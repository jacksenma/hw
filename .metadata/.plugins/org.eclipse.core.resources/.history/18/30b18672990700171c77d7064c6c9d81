...
//	        	var pc=$("#myDIV");
	        	...
	        	if(d.length==0){
	        		$("#pageControl").attr("style","display:none");
//	        		$("#sorry").attr("style","display:block");
	        		toastr.warning('抱歉，未找到符合条件的客栈');
	        	}else{
	        		$("#pageControl").attr("style","display:block");
//	        		$("#sorry").attr("style","display:none");
	        	}
...
//		var pimgtd=$("<td class="+imgclass+"></td>");
		...
		var sname=$("<p>名称:<span style='font-size:16px;'>"+name+"</span></p>");
