...
<div class="content">
  <div class="wrapper">
    ...
    <div class="main">
      <h1 class="title">Hostel World时间轴</h1>
      <c:forEach items="${orderTimeLine}" var="o">
      	<c:if test="${o.state==0 }">
      		
      	<div class="year">
        <h2><a href="#">${fn:split(o.orderDate," ")[0]}
        <i></i></a></h2>
        <div class="list">
          <ul>
            <li class="cls">
              <p class="date">${fn:split(o.orderDate," ")[1]}</p>
              <p class="intro">预定客栈</p>
              <p class="version">&nbsp;</p>
              <div class="more">
                <p>预定了位于${o.haddress }的名为${o.hname}的${o.hlevel }客栈</p>
              </div>
            </li>
            <c:if test="${fn:split(o.orderDate,' ')[0]  == fn:split(o.leaveDate,' ')[0] }">
      			<li class="cls">
              	<p class="date">${fn:split(o.leaveDate," ")[1]}</p>
              	<p class="intro">取消预订</p>
              	<p class="version">&nbsp;</p>
              	<div class="more">
                	<p>取消预定位于${o.haddress }的名为${o.hname}的${o.hlevel }客栈</p>
              	</div>
            	</li>
            </c:if>
      		...
      		<c:if test="${fn:split(o.orderDate,' ')[0]  != fn:split(o.leaveDate,' ')[0] }">
      			<div class="year">
        <h2><a href="#">${fn:split(o.leaveDate,' ')[0]}<i></i></a></h2>
        <div class="list">
          <ul>
           <li class="cls">
              	<p class="date">${fn:split(o.leaveDate," ")[1]}</p>
        ...
        <div class="list">
          <ul>
            ...
            <li class="cls">
              <p class="date">${fn:split(o.orderDate," ")[1]}</p>
              <p class="intro">入住客栈</p>
              <p class="version">&nbsp;</p>
              <div class="more">
                <p>入住位于${o.haddress }的名为${o.hname}的${o.hlevel }客栈</p>
              </div>
            </li>
            <li class="cls">
              <p class="date">${fn:split(o.orderDate," ")[1]}</p>
              <p class="intro">离开客栈</p>
              <p class="version">&nbsp;</p>
              <div class="more">
                <p>离开位于${o.haddress }的名为${o.hname}的${o.hlevel }客栈</p>
              </div>
            </li>
          </ul>
        </div>
