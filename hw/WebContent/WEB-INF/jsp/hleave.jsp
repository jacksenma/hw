...
<div id="container" >
	<div id="leaveBox" class="col-lg-4 col-lg-offset-4 col-sm-6 col-sm-offset-3 col-xs-8 col-xs-offset-2" >
    ...
    <div class="tab-pane fade" id="notVip">
        <form class="form" action="hleaveNotVip" method="post" id="hleaveNotVip">
			...
			<span>房间类型:</span>
      		...
      		<div>
			<span>房间数量:</span><input type="text" class="form-control" id="nnum" name="nnum" placeholder="请输入房间数量" >
            </div>
            <div>
